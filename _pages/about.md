...
I hold a PhD from [Drexel University](https://drexel.edu/cci/){:target="_blank"}’s School of Computer and Information Sciences (formerly the College of Computing and Informatics), where I conducted my doctoral research under the guidance of [Prof Christopher Yang](http://cci.drexel.edu/faculty/cyang/){:target="_blank"} in the Health Informatics research group.
